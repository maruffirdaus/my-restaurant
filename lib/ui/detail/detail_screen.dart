...
import '../../provider/customer_reviews/customer_reviews_result_state.dart';
import '../../provider/restaurant_detail/restaurant_detail_provider.dart';
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      context.read<RestaurantDetailProvider>().getRestaurantDetails(widget.id);
    });
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Consumer<CustomerReviewsProvider>(
                                builder: (context, value, child) {
                              return switch (value.resultState) {
                                CustomerReviewsLoadingState() => const SizedBox(
                                    width: double.infinity,
                                    height: 120,
                                    child: Center(
                                      child: CircularProgressIndicator(),
                                ...
                                CustomerReviewsLoadedState(
                                  data: var customerReviews
                                ) =>
                                  SizedBox(
                                    height: 120,
                                    child: ListView.separated(
                                ...
                                CustomerReviewsErrorState(error: var error) =>
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 24),
                                    child: Text(
                                ...
                                _ => restaurant.customerReviews.isEmpty
                                    ...
                                    : SizedBox(
                                        ...
                                        child: ListView.separated(
                                          ...
                                          itemBuilder: (context, index) {
                                            final customerReview = restaurant
                                                .customerReviews[index];
          ...
          _ => Scaffold(
              body: Center(
                child: Padding(
                  ...
                  child: MessageCard(
                    message:
                        const Text('There is no detail about the restaurant'),
                    child: OutlinedButton(
                      onPressed: () {
                        Navigator.pop(context);
                      },
